...
class PlannerSettings:
    ...
    WORKER_HEARTBEAT_TIMEOUT_SECONDS: int = int_env("WORKER_HEARTBEAT_TIMEOUT_SECONDS", 15)
    WORKER_HEARTBEAT_TIMEOUT_CHECK_SECONDS: int = int_env("WORKER_HEARTBEAT_TIMEOUT_CHECK_SECONDS", 5)
